...
class m140418_204054_users extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%users}}', [
            ...
            'auth_key' => Schema::TYPE_STRING . ' NOT NULL COMMENT "Секретный ключ авторизации"',
            'secure_key' => Schema::TYPE_STRING . ' NOT NULL COMMENT "Секретный ключ"',
        ...
        $this->createTable('{{%users_profile}}', [
            ...
            'about_me' => Schema::TYPE_TEXT . ' NULL DEFAULT NULL COMMENT "О себе"',
