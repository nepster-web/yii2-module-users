...
<div class="row">
    <div class="col-md-3 col-md-4 col-sm-4 col-xs-6 col-lg-4"><?= $form->field($user, 'group') ?></div>
    <div class="col-md-3 col-md-4 col-sm-4 col-xs-6 col-lg-4"><br/><?= Html::a(Yii::t('users', 'RBAC'), ['/users/rbac/to-user', 'id' => $user->id]) ?></div>
</div>
<div class="row">
